...
const Dropdown = ({ options, placeholder, dropdownName, onOptionChange }) => {
    ...
    useEffect(() => {
        // Call the callback function whenever selected options change
                ...
                <div className="dropdown-header" onClick={() => setIsOpen(!isOpen)}>
                    ...
                    <div className="dropdown-icon">
                        {selectedOptions.length > 0 && (
                            <div className="cross-arrow" onClick={() => setSelectedOptions([])}>
